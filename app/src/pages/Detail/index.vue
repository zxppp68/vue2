<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <!-- 初始是空对象，会undefined.category1Name然后报错 -->
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd @click="changeActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)" changepirce="0" :class="{active:spuSaleAttrValue.isChecked==1}" v-for="(spuSaleAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 这里加入购物车的路由跳转需要先把商品信息通过请求的方式发给服务器，服务器要存储 -->
